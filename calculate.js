	...
	switch(type) {
		...
		default:
			if (pounds == 0) {
				...
				if (ounces == 0) { price= zeroPoundParcelPrices[0]; }
				else if (ounces >= 1 && ounces < 5) { price = zeroPoundParcelPrices[1]; }
				else if (ounces >=5 && ounces < 9 ) { price = zeroPoundParcelPrices[2]; }
				else if (ounces >= 9 && ounces < 13) { price = zeroPoundParcelPrices[3]; }
				else { price = zeroPoundParcelPrices[4]; }
			} else {
